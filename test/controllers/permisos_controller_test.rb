...
class PermisosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create permiso" do
    assert_difference('Permiso.count') do
      post permisos_url, params: { permiso: { descripcion: @permiso.descripcion, tipopermiso: @permiso.tipopermiso } }
    end
  ...
  test "should update permiso" do
    patch permiso_url(@permiso), params: { permiso: { descripcion: @permiso.descripcion, tipopermiso: @permiso.tipopermiso } }
