...
class NotificacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notificacion" do
    assert_difference('Notificacion.count') do
      post notificacions_url, params: { notificacion: { fecha: @notificacion.fecha, mensaje: @notificacion.mensaje } }
    end
  ...
  test "should update notificacion" do
    patch notificacion_url(@notificacion), params: { notificacion: { fecha: @notificacion.fecha, mensaje: @notificacion.mensaje } }
